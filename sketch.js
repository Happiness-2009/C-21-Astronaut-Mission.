...
function draw() {
  ...
  textSize(17);
  text("Up Arrow = Brushing For Clean Teeth",20, 55);
  text("Down Arrow = Gymming For Fitness",20, 70);
  text("Left Arrow = Eating For Health",20, 85);
  text("Right Arrow = Bathing For Cleanliness",20, 100);
  text("M key = Moving For Fun",20, 115);
